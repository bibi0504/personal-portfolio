...
export default [
    ...
    {
        name: 'Encocare',
        coverUrl: '/images/portfolio/encocare.png',
        description:
            'Encocare is an eye testing project that helps individuals assess their eye health and enables healthcare professionals to manage and analyze test results effectively.',
        githubUrl: 'https://github.com/bibi0504/encocare',
        previewUrl: 'http://54.152.39.171/',
